...
class FriendsAdapter(var context: Context, var friendsList: ArrayList<User>): RecyclerView.Adapter<FriendsAdapter.ViewHolder>() {
    ...
    private lateinit var onFriendsClickListener: OnFriendsClickListener
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            onFriendsClickListener.onFriendClick(friendsList[position])
        }
    }

    fun setOnFriendClickListener(onFriendsClickListener: OnFriendsClickListener) {
